...
const getState = (c) => {
  const state = {
    additionalRequestParams: c.additionalRequestParams,
    analyticsCollectionName: c.analytics.collectionIdentifier,
    analyticsTrackImpression: c.analytics.trackImpressions,
    andLogicTags: c.andLogicTags,
    autoCountryLang: c.autoCountryLang,
    ...
    country: c.countryState,
    contentTypeTags: c.contentTypeTags,
    disableBanners: c.collection.disableBanners,
    doNotLazyLoad: c.doNotLazyLoad,
    draftDb: false,
    environment: '',
    excludeTags: c.excludeTags,
    excludedCards: c.excludedCards,
    fallbackEndpoint: '',
    featuredCards: c.featuredCardsState,
